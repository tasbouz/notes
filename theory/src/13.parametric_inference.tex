...
In this chapter we will introduce another way of inference called \say{parametric inference}. In this model the goal
...
Due to the \say{max} term that appears in total variation distance it's very hard to manipulate it. Fortunately,
...
is defined in term of their PDFs as follows:
\bse
...
The solution of either of these equations gives back the best estimator. This process is called \say{the principle of
maximum likelihood} or simply \say{the maximum likelihood method}.
