...
The balance sheet presents what the enterprise has today (assets\ref{def:asset}), how much the enterprise owes today
(liabilities\ref{def:liability}), and what the enterprise is worth today (equity). \v
