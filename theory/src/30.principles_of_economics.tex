...
An intangible asset is usually very difficult to valuate. They suffer from non-rivalry and non-excludability. \v

Finaly, there is a third category in-between the first two, called ``financial assets''.

\bd[Financial Asset] \label{def:financial_asset}
...
\bd[Liability] \label{def:liability}
...
In simple words liabilities are everything you owe. \v

More on financial assets and liabilities in the next chapters.
