...
\bd[Session]
A \textbf{session} is a semi-permanent interactive information exchange among communicating devices.
\ed

\bd[Session Layer]
The \textbf{session layer} is the fifth layer of the OSI model, and it is the one responsible for establishing,
managing, synchronizing, and terminating sessions. Its PDU is data.
\ed
