...
Notice that the notions of open and closed sets, as defined, are not mutually exclusive. A set could be both or
...
\begin{align*}
\mathrm{preim}_\phi(\vn)
&= \vn, & \mathrm{preim}_\phi(\{2\}) &= \{a,c\}, & \mathrm{preim}_\phi(\{3\}) &= \vn\mathrm{preim}_\phi(\{1,3\})
&= \{b\}, & \mathrm{preim}_\phi(\{2,3\})
&=\{a,c\}, & \mathrm{preim}_\phi(\{1,2,3\})
&= \{a,b,c\}
\end{align*}
