...
\usepackage{graphicx, geometry, mathtools, amsthm, amsmath, enumitem, float, dirtytalk, textcomp, amssymb, cancel, bm,
hyperref, IEEEtrantools, mathrsfs, xfrac, pgfplots, bbding, titlepic,cleveref, stmaryrd, movie15, subfig, tikz, tikz-cd,
fontspec, adjustbox, lmodern, color, xcolor, listings, courier, multirow, caption, booktabs, microtype}
...
\definecolor{scheduled}{RGB}{204, 181, 145}
\definecolor{queued}{RGB}{118, 118, 118}
\definecolor{running}{RGB}{96, 206, 63}
\definecolor{success}{RGB}{55, 126, 34}
\definecolor{failed}{RGB}{232, 50, 35}
\definecolor{skipped}{RGB}{200, 159, 168}
\definecolor{upstream_failed}{RGB}{242, 169, 59}
\definecolor{up_for_retry}{RGB}{249, 218, 74}
\definecolor{up_for_reschedule}{RGB}{108, 205, 194}
\definecolor{shutdown}{RGB}{0, 0, 255}
