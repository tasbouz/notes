...
\section[Airflow] {Airflow\footnote{This chapter requires prior knowledge on the concept of ``cron''. The reader is
advised to read the part of the notes on ``Cron'' (\ref{subsec:cron}) before proceeding.}}
