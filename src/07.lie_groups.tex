...
Let $(G,\bullet)$ and $(H,\circ)$ be Lie groups. A map $\phi\cl G \to H$ is \textbf{Lie group homomorphism} if it is a
group
...
$g$ (Hence, the index in $\ell_g$) and then apply this element to the whole group (a.k.a.\ to each element of the
group). \v
...
the derivative of the first component (a.k.a.\ $ae+bg$) with respect to the first variable (a.k.a.\ $e$) hence, the
result
...
semi-definite, i.e.\ $\kappa(X,X) \neq 0$, for all $X$ in the Lie algebra. Hence, $\SL(2,\C)$ is not a compact Lie
group.
