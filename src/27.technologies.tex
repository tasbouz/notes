...
agent is, and is not, allowed to do, and we will see later how this is handled in practice through permission systems. \v
...
Notion, and virtually every popular developer service. MCP servers communicate with the client either over ``stdio'' (the server runs locally as
