...
\bse
\textit{Price Elasticity Of Demand} = \frac{\textit{Percentage Change In Quantity Demanded}}
{\textit{Percentage Change In Price}}
\ese
\ed
...
\bse
\textit{Income Elasticity Of Demand} = \frac{\textit{Percentage Change In Quantity Demanded}}
{\textit{Percentage Change In Income}}
\ese
\ed
...
\bse
\textit{Cross-Price Elasticity Of Demand} = \frac{\textit{Percentage Change In Quantity Demanded Of Good A}}
{\textit{Percentage Change In Price Of Good B}}
\ese
\ed
...
\bse
\textit{Price Elasticity Of Demand} > 1
\ese
\ed
...
\bse
\textit{Price Elasticity Of Demand} \to \infty
\ese
\ed
...
\bse
\textit{Price Elasticity Of Demand} = 0
\ese
\ed
...
\bse
\textit{Price Elasticity Of Supply} = \frac{\textit{Percentage Change In Quantity Supplied}}
{\textit{Percentage Change In Price}}
\ese
\ed
...
\bse
\textit{Income Elasticity Of Supply} = \frac{\textit{Percentage Change In Quantity Supplied}}
{\textit{Percentage Change In Income}}
\ese
\ed
...
\bse
\textit{Cross-Price Elasticity Of Demand} = \frac{\textit{Percentage Change In Quantity Supplied Of Good A}}
{\textit{Percentage Change In Price Of Good B}}
\ese
\ed
...
\bse
\textit{Price Elasticity Of Supply} > 1
\ese
\ed
...
\bse
\textit{Price Elasticity Of Supply} \to \infty
\ese
\ed
...
\bse
\textit{Price Elasticity Of Supply} = 0
\ese
\ed
...
\bse
\textit{Total Revenue} = Price \times Quantity
\ese
\ed
...
\begin{align}
\textit{Total Surplus } & \textit{= (Consumer Surplus) + (Producer Surplus)} \nonumber \\
& \textit{= (Willignes To Pay - Amount Paid) + (Amount Received - Cost)} \nonumber \\
& \textit{= Willignes To Pay - Amount Paid + Amount Received - Cost} \nonumber \\
& \textit{= Willignes To Pay - Cost} \nonumber
\end{align}
...
Note that the equilibrium quantity of steel, $Q_\textit{MARKET}$, is larger than the socially optimal quantity,
$Q_\textit{OPTIMUM}$. This inefficiency occurs because the market equilibrium reflects only the private costs of
production. In the market equilibrium, the marginal consumer values steel at less than the social cost of producing
it. That is, at $Q_\textit{MARKET}$, the demand curve lies below the social-cost curve. Thus, reducing steel
...
Political economy is the study of how economic systems (e.g.\ markets and national economies) and political systems (e
.g.\ law, institutions, government) are linked. Widely studied phenomena within the discipline are systems
...
word forhousehold management. The earliest works of political economy are usually attributed to the British
...
perfect but is good enough. The model of rational man may be the theory of choice for a satisficing social scientist. \v

For more context, check Appendix~\ref{ch:thinking_fast_and_slow}.