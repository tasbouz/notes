...
Moving on to some more advanced characteristics, we have the concepts of ``fault tolerance'' and ``network
reliability'',
...
gateway. The function that does the translation between different network technologies is called a protocol converter.
\v
