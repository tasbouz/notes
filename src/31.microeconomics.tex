...
\bd[Elastic Supply]
Supply for a good is said to be \textbf{elastic} if the quantity supplied responds substantially to changes in the
price.
...
``adverse selection'', and we will see how individuals may respond to the problem with ``signaling'' or ``screening''.
\v
