...
very small portion of the population called a \say{sample}. (To not be confused with \say{sample space})
\ee
...
\fig{population_and_sample}{0.14}
...
definitions based on the way of collecting a sample.
...
The law of large numbers can find an application in statistics since, the \say{random variable $X$ that follows a
probability distribution $P$ with mean $\mu$} can be translated to a population, and the \say{collection of $n$
