...
called \say{counting measure} and it is the usual measure on countable measurable spaces.
\ee
...
general measure, as introduced by Lebesgue, or the specific case of integration of a function defined on a sub-domain
...
The monotone convergence theorem can be used to extend some of properties of integrals of non-negative, measurable
