...
Examples of ordinal scaled data include data as \say{sick} vs \say{healthy} when measuring health, \say{guilty} vs.
\say{not-guilty} when making judgments in courts, or clothing size: Small, Medium, Large, Extra Large etc.
